...
<div id="wrapper">
    <div id="main">
        ...
        <form method="post">
            <fieldset>
                <legend style="margin-left: 50px"><h2 style="color:brown">List subscriber</h2>
                </legend>
                <table style="margin-left: 50px; width: auto">
                    ...
                    <c:forEach items='${requestScope["subscribers"]}' var="subscriber">
                        <tr>
                            <td><a>${subscriber.getId()}</a></td>
