...
<div id="wrapper">
    <div id="main">
        ...
        <form method="post">
            <fieldset>
                <legend style="margin-left: 50px"><h2 style="color:brown">Event List</h2></legend>
                <h3><a style="margin-left: 50px" href="/events?action=create" type="button" class="btn btn-success" >Create new event</a></h3>
                <table style="margin-left: 50px; width: auto">
                    ...
                    <c:forEach items="${requestScope['eventList']}" var="event">
                        <tr>
                            ...
                            <td>
                                <a href="/events?action=delete&id=${event.getId()}" type="button" class="btn btn-success">Delete/Restore</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
