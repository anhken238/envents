...
<div id="wrapper">
    <div id="main">
        ...
        <form method="post">
            <fieldset>
                <fieldset>
                    <legend style="margin-left: 50px"><h2 style="color:brown">CREATE EVENT</h2></legend>
                    <table style="margin-left: 50px; width: auto">
                        <tr>
                            <th>Event name</th>
                            <td><input type="text" name="eventName" id="eventName" size="50"></td>
                        </tr>
                        <tr>
                            <th>Image</th>
                        ...
                        <tr>
                            <th>Image note</th>
                            <td><input type="text" name="imageNote" id="imageNote" size="50"></td>
                        </tr>
                        <tr>
                            <th>Place</th>
                        ...
                        <tr>
                            <th>Day Organize</th>
                            <td><input type="date" name="dayOrganize" id="dayOrganize"></td>
                        </tr>
                        <tr>
                            <th>Organizer</th>
                            <td><input type="text" name="organizer" id="organizer" size="50"></td>
                        </tr>
                        <tr>
                            <th>Introduce</th>
                        ...
                        <tr>
                            ...
                            <td><textarea rows="4" cols="100" name="detailedProgram" id="detailedProgram"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th>Category</th>
                            <td><input type="text" name="category" id="category" size="50"></td>
                        </tr>
                        <tr>
                            <td>
                                <input type="submit" value="Create an event" class="btn btn-success">
                            </td>
                            <td>
