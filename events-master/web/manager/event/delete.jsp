...
<div id="wrapper">
    <div id="main">
        ...
        <form method="post">
            <fieldset>
                <legend style="margin-left: 50px"><h2 style="color:brown">DELETE / RESTORE</h2></legend>
                <table style="margin-left: 50px; width: auto">
                    ...
                    <tr>
                        <th>Image note</th>
                        <td>${requestScope["event"].getImage_note()}</td>
                    </tr>
                    <tr>
                        <th>Place</th>
                    ...
                    <tr>
                        <th>Category</th>
                        <td>${requestScope["event"].getCategory()}</td>
                    </tr>
                    <tr>
                        <th></th>
                        <td>
                            <%
                                if (((String) request.getAttribute("is_Delete")).equals("0")) {
                            %>
