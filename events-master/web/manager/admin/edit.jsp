                ...
                <table style="margin-left: 50px; width: auto">
                    <tr>
                        ...
                        <td><input type="text" name="fullName" id="fullName"
                                   value="${requestScope["admin"].getFullName()}"></td>
                    </tr>
                    <tr>
                        <td>Birthday:</td>
                        <td><input type="text" name="dayOfBirth" id="dayOfBirth"
                                   value="${requestScope["admin"].getDayOfBirth()}"></td>
                    </tr>
                    <tr>
                        <td>Phone Number:</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="address" id="address"
                                   value="${requestScope["admin"].getAddress()}"></td>
                    </tr>
                    <tr>
                        <td><input type="submit" value="Update Admin information" class="btn btn-success"></td>
                        <td><a href="/admins?action=view&id=1" class="btn btn-success">Back to admin page</a></td>
                    </tr>
                </table>
            </fieldset>
        </form>
