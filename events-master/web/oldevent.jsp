...
<section class="grid3d vertical portfolio" id="portfolio">
    <div class="container" id="features">
        <div class="teams-heading text-center col-md-8 offset-md-2 col-sm-12 text-center">
            ...
            <h2 class="teams-heading">SỰ KIỆN ĐÃ DIỄN RA</h2>
        </div>
    </div>
    ...
    <div class="grid-wrap">
        <div class="grid">
            <div class="row">
                <c:forEach items='${requestScope["eventListOld"]}' var="event">
                    <div class="col-sm">
                        <div class="blog-item-box">
                            <figure class="blog-item">
                                <div class="image">
                                    <img src="${event.getImage()}" alt="image" style="width: 100%;height: 100%">
                                    <div>
                                        <span class="month">
                                                ${event.getDayOrganize()}
                                        </span>
                                    </div>
                                </div>
                                <figcaption>
                                    <h5>${event.getName_event()}"</h5>
                                    <p>${event.getIntroduce()}"</p>
